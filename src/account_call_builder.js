...
export class AccountCallBuilder extends CallBuilder {
     ...
     * @see [All Accounts](https://www.rover.network/developers/orbit/reference/accounts-all.html)
     * @constructor
     * @extends CallBuilder
     ...
     *
     * @see [Account Details](https://www.rover.network/developers/orbit/reference/accounts-single.html)
