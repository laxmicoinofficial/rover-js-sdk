...
export class OperationCallBuilder extends CallBuilder {
     ...
     * @see [All Operations](https://www.rover.network/developers/orbit/reference/operations-all.html)
     * @constructor
     * @extends CallBuilder
     * @param {string} serverUrl Orbit  server URL.
     */
     ...
     * @see [Operation Details](https://www.rover.network/developers/orbit/reference/operations-single.html)
     ...
     * @see [Operations for Account](https://www.rover.network/developers/orbit/reference/operations-for-account.html)
     ...
     *
     * @see [Operations for Ledger](https://www.rover.network/developers/orbit/reference/operations-for-ledger.html)
     ...
     * @see [Operations for Transaction](https://www.rover.network/developers/orbit/reference/operations-for-transaction.html)
