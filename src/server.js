...
/**
 * Server handles the network connection to a [Orbit ](https://www.rover.network/developers/orbit/reference/index.html)
 * instance and exposes an interface for requests to that instance.
 * @constructor
 * @param {string} serverURL Orbit  Server URL (ex. `https://orbit-testnet.rover.network`).
 * @param {object} [opts]
...
export class Server {
    constructor(serverURL, opts = {}) {
        ...
        if (this.serverURL.protocol() != 'https' && !allowHttp) {
            throw new Error('Cannot connect to insecure orbit server');
        }
    }

    /**
     * Submits a transaction to the network.
     * @see [Post Transaction](https://www.rover.network/developers/orbit/reference/transactions-create.html)
     * @param {Transaction} transaction - The transaction to submit.
     * @returns {Promise} Promise that resolves or rejects with response from orbit.
     */
    ...
    /**
     * Returns new {@link AccountCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * Returns new {@link LedgerCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * Returns new {@link TransactionCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * People on the Rover network can make offers to buy or sell assets. This endpoint represents all the offers a particular account makes.
    ...
    /**
     * Returns new {@link OrderbookCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * Returns new {@link TradesCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * Returns new {@link OperationCallBuilder} object configured by a current Orbit  server configuration.
    ...
    /**
     * The Rover Network allows payments to be made between assets through path payments. A path payment specifies a
     ...
     *
     * As part of the search, orbit will load a list of assets available to the source address and will find any
     ...
     *
     * Returns new {@link PathCallBuilder} object configured with the current Orbit  server configuration.
     *
    ...
    /**
     * Returns new {@link PaymentCallBuilder} object configured with the current Orbit  server configuration.
    ...
    /**
     * Returns new {@link EffectCallBuilder} object configured with the current Orbit  server configuration.
    ...
    /**
     * Returns new {@link FriendbotBuilder} object configured with the current Orbit  server configuration.
    ...
    /**
     * Returns new {@link AssetsCallBuilder} object configured with the current Orbit  server configuration.
    ...
    */
     ...
     * Returns new {@link TradeAggregationCallBuilder} object configured with the current Orbit  server configuration.
