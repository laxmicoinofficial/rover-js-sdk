describe("server.js tests", function () {
  beforeEach(function () {
    this.server = new RoverSdk.Server('http://orbit-testnet.rover.network:1337');
  ...
  describe('Server.constructor', function () {
    it("throws error for insecure server", function () {
      expect(() => new RoverSdk.Server('http://orbit-testnet.rover.network:1337')).to.throw(/Cannot connect to insecure orbit server/);
    });

    it("allow insecure server when opts.allowHttp flag is set", function () {
      expect(() => new RoverSdk.Server('http://orbit-testnet.rover.network:1337', {allowHttp: true})).to.not.throw();
    });

    it("allow insecure server when global Config.allowHttp flag is set", function () {
      RoverSdk.Config.setAllowHttp(true);
      expect(() => new RoverSdk.Server('http://orbit-testnet.rover.network:1337')).to.not.throw();
    });
  });
  ...
  describe('Server.loadAccount', function () {
    let accountResponse = {
      "_links": {
        "self": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS"
        },
        "transactions": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/transactions{?cursor,limit,order}",
          "templated": true
        },
        "operations": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/operations{?cursor,limit,order}",
          "templated": true
        },
        "payments": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/payments{?cursor,limit,order}",
          "templated": true
        },
        "effects": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/effects{?cursor,limit,order}",
          "templated": true
        },
        "offers": {
          "href": "https://orbit-testnet.rover.network/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/offers{?cursor,limit,order}",
          "templated": true
        }
      },
    ...
    it("returns AccountResponse object", function (done) {
      this.axiosMock.expects('get')
        .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS'))
  ...
  describe('Server._sendResourceRequest', function () {
    ...
    describe("requests all ledgers", function () {
      ...
      describe("without options", function () {
        it("requests the correct endpoint", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers'))
      ...
      describe("with options", function () {
        beforeEach(function() {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers?limit=1&cursor=b&order=asc'))
            .returns(Promise.resolve({data: ledgersResponse}));
        });
        ...
        it("can call .next() on the result to retrieve the next page", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers?order=asc&limit=1&cursor=4294967296'))
            .returns(Promise.resolve(({data: ledgersResponse})));
    ...
    describe("requests a single ledger", function () {
      ...
      describe("for a non existent ledger", function () {
        it("throws a NotFoundError", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/1'))
          ...
          this.server.ledgers()
            ...
            .catch(RoverSdk.NotFoundError, function (err) {
              done();
            })
            .catch(function (err) {
              done(err);
      ...
      describe("with options", function () {
        it("requests the correct endpoint", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/1?limit=1&cursor=b&order=asc'))
            .returns(Promise.resolve({data: singleLedgerResponse}));
    ...
    describe("requests a sub resource", function (done) {
      let transactionsResponse = {
          "_links": {
            "self": {
              "href": "http://orbit.rover.network/transactions?order=desc\u0026limit=1\u0026cursor="
            },
            "next": {
              "href": "http://orbit.rover.network/transactions?order=desc\u0026limit=1\u0026cursor=34156680904183808"
            },
            "prev": {
              "href": "http://orbit.rover.network/transactions?order=asc\u0026limit=1\u0026cursor=34156680904183808"
            }
          },
          "_embedded": {
            "records": [
              {
                "_links": {
                  "self": {
                    "href": "http://orbit.rover.network/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1"
                  },
                  "account": {
                    "href": "http://orbit.rover.network/accounts/GBURK32BMC7XORYES62HDKY7VTA5MO7JYBDH7KTML4EPN4BV2MIRQOVR"
                  },
                  "ledger": {
                    "href": "http://orbit.rover.network/ledgers/7952722"
                  },
                  "operations": {
                    "href": "http://orbit.rover.network/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/operations{?cursor,limit,order}",
                    "templated": true
                  },
                  "effects": {
                    "href": "http://orbit.rover.network/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/effects{?cursor,limit,order}",
                    "templated": true
                  },
                  "precedes": {
                    "href": "http://orbit.rover.network/transactions?order=asc\u0026cursor=34156680904183808"
                  },
                  "succeeds": {
                    "href": "http://orbit.rover.network/transactions?order=desc\u0026cursor=34156680904183808"
                  }
                },
      ...
      describe("without options", function () {
        it("requests the correct endpoint", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/7952722/transactions'))
            .returns(Promise.resolve({data: transactionsResponse}));

          this.axiosMock.expects('get')
            .withArgs(sinon.match(/^https:\/\/orbit.rover.network\/transactions\/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1\/operations/))
      ...
      describe("with options", function () {
        it("requests the correct endpoint", function (done) {
          this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/7952722/transactions?cursor=b&limit=1&order=asc'))
            .returns(Promise.resolve({data: transactionsResponse}));

          this.axiosMock.expects('get')
            .withArgs(sinon.match(/^https:\/\/orbit.rover.network\/transactions\/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1\/operations\?limit=1/))
            .returns(Promise.resolve({data: {operations: []}}));
  ...
  describe('Server.submitTransaction', function() {
    it("sends a transaction", function(done) {
      ...
      let transaction = new RoverSdk.TransactionBuilder(account)
      ...
      this.axiosMock.expects('post')
        .withArgs('http://orbit-testnet.rover.network:1337/transactions', `tx=${blob}`)
  ...
  describe("Smoke tests for the rest of the builders", function() {
    describe("AccountCallBuilder", function() {
      ...
      it("requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K'))
    ...
    describe("OfferCallBuilder", function() {
      ...
      it("requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/offers?order=asc'))
    ...
    describe("OrderbookCallBuilder", function() {
      ...
      it("requests the correct endpoint native/credit", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=USD&buying_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG'))
          .returns(Promise.resolve({data: orderBookResponse}));

        this.server.orderbook(RoverSdk.Asset.native(), new RoverSdk.Asset('USD', "GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG"))
          .call()
          .then(function (response) {
      ...
      it("requests the correct endpoint credit/native", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/order_book?selling_asset_type=credit_alphanum4&selling_asset_code=USD&selling_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&buying_asset_type=native'))
          .returns(Promise.resolve({data: orderBookResponse}));

        this.server.orderbook(new RoverSdk.Asset('USD', "GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG"), RoverSdk.Asset.native())
          .call()
          .then(function (response) {
            expect(response).to.be.deep.equal(orderBookResponse);
            done();
    ...
    describe("TradesCallBuilder", function() {
      it("trades() requests the correct endpoint (no filters)", function (done) {
        let tradesResponse = {
          _links: {
            self: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=asc&limit=200&cursor="
            },
            next: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=asc&limit=200&cursor=64199539053039617-0"
            },
            prev: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=desc&limit=200&cursor=64199539053039617-0"
            }
          },
          _embedded: {
            records: [
              {
                _links: {
                  base: {
                    href: "http://orbit-testnet.rover.network:1337/accounts/GB7JKG66CJN3ACX5DX43FOZTTSOI7GZUP547I3BSXIJVUX3NRYUXHE6W"
                  },
                  counter: {
                    href: "http://orbit-testnet.rover.network:1337/accounts/GC6APVH2HCFB7QLSTG3U55IYSW7ZRNSCTOZZYZJCNHWX2FONCNJNULYN"
                  },
                  operation: {
                    href: "http://orbit-testnet.rover.network:1337/operations/64199539053039617"
                  }
                },
        ...
        this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trades'))
      ...
      it("trades() requests the correct endpoint for assets", function (done) {
        let tradesResponse = {
          _links: {
            self: {
              href: "http://orbit-testnet.rover.network:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=asc&limit=10&cursor="
            },
            next: {
              href: "http://orbit-testnet.rover.network:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=asc&limit=10&cursor=64199539053039617-0"
            },
            prev: {
              href: "http://orbit-testnet.rover.network:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=desc&limit=10&cursor=64199539053039617-0"
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM'))
            .returns(Promise.resolve({data: tradesResponse}));

        this.server.trades()
            .forAssetPair(RoverSdk.Asset.native(), new RoverSdk.Asset('JPY', "GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM"))
            .call()
            .then(function (response) {
              expect(response.records).to.be.deep.equal(tradesResponse._embedded.records);
              done();
      ...
      it("trades() requests the correct endpoint for offer", function (done) {
        let tradesResponse = {
          _links: {
            self: {
              href: "http://orbit-testnet.rover.network:1337/trades?offer_id=278232&order=asc&limit=10&cursor="
            },
            next: {
              href: "http://orbit-testnet.rover.network:1337/trades?offer_id=278232&order=asc&limit=10&cursor=64199539053039617-0"
            },
            prev: {
              href: "http://orbit-testnet.rover.network:1337/trades?offer_id=278232&order=desc&limit=10&cursor=64199539053039617-0"
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trades?offer_id=278232'))
            .returns(Promise.resolve({data: tradesResponse}));
      ...
      it("trades() requests the correct endpoint for paging", function (done) {
        let tradesResponse = {
          _links: {
            self: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=asc&limit=1&cursor=64199539053039617-0"
            },
            next: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=asc&limit=1&cursor=64199676491993090-0"
            },
            prev: {
              href: "http://orbit-testnet.rover.network:1337/trades?order=desc&limit=1&cursor=64199676491993090-0"
            }
          },
          _embedded: {
            records: [
              {
                _links: {
                  base: {
                    href: "http://orbit-testnet.rover.network:1337/accounts/GBBHSWC3XSUFKEFDPQO346BCLM3EAJHICWRVSVIQOG4YBIH3A2VCJ6G2"
                  },
                  counter: {
                    href: "http://orbit-testnet.rover.network:1337/accounts/GDBXANSAUQ5WBFSA6LFQXR5PYVYAQ3T4KI4LHZ3YAAEFI3BS2Z3SFRVG"
                  },
                  operation: {
                    href: "http://orbit-testnet.rover.network:1337/operations/64199676491993090"
                  }
                },
        ...
        this.axiosMock.expects('get')
            .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trades?order=asc&limit=1&cursor=64199539053039617-0'))
            .returns(Promise.resolve({data: tradesResponse}));
    ...
    describe("PathsCallBuilder", function() {
      ...
      it("requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/paths?destination_account=GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V&source_account=GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP&destination_amount=20.0&destination_asset_type=credit_alphanum4&destination_asset_code=EUR&destination_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN'))
          .returns(Promise.resolve({data: pathsResponse}));

        this.server.paths("GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP","GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V", new RoverSdk.Asset('EUR', 'GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN'), '20.0')
          .call()
          .then(function (response) {
    ...
    describe("EffectCallBuilder", function() {
      ...
      it("requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/effects?cursor=b'))
      ...
      it("forAccount() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GCGHCFUB6JKQE42C76BK2LYB3EHKP4WQJE624WTSL3CU2PPDYE5RBMJE/effects'))
          .returns(Promise.resolve({data: effectsResponse}));
      ...
      it("forTransaction() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/transactions/ef37d6770c40c3bdb6adba80759f2819971396d1c3dfb7b5611f63ad72a9a4ae/effects'))
          .returns(Promise.resolve({data: effectsResponse}));
    ...
    describe("OperationCallBuilder", function() {
      ...
      it("operation() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/operations/123456789'))
      ...
      it("forAccount() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GCGHCFUB6JKQE42C76BK2LYB3EHKP4WQJE624WTSL3CU2PPDYE5RBMJE/operations'))
          .returns(Promise.resolve({data: operationsResponse}));
      ...
      it("forLedger() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/123456789/operations'))
          .returns(Promise.resolve({data: operationsResponse}));
      ...
      it("forTransaction() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/transactions/blah/operations'))
          .returns(Promise.resolve({data: operationsResponse}));
    ...
    describe("PaymentCallBuilder", function() {
      ...
      it("forAccount() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/payments'))
      ...
      it("forLedger() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/ledgers/123456789/payments'))
          .returns(Promise.resolve({data: paymentsResponse}));
      ...
      it("forTransaction() requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/transactions/77277606902d80a03a892536ebff8466726a4e55c3923ec2d3eeb3aa5bdc3731/payments'))
          .returns(Promise.resolve({data: paymentsResponse}));
    ...
    describe("FriendbotCallBuilder", function() {
      ...
      it("requests the correct endpoint", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/dakibot?addr=GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K'))
    ...
    describe("TradeAggregationCallBuilder", function () {
      let tradeAggregationResponse = {
        "_links": {
          "self": {
            "href": "http://orbit.rover.network/trade_aggregations?base_asset_type=native\u0026counter_asset_type=credit_alphanum4\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026start_time=1512689100000\u0026end_time=1512775500000\u0026resolution=300000"
          },
          "next": {
            "href": "http://orbit.rover.network/trade_aggregations?base_asset_type=native\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026counter_asset_type=credit_alphanum4\u0026end_time=1512775500000\u0026resolution=300000\u0026start_time=1512765000000"
          },
          "prev": {
            "href": ""
          }
      ...
      it("requests the correct endpoint native/credit", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trade_aggregations?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=BTC&counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH&start_time=1512689100000&end_time=1512775500000&resolution=300000'))
          .returns(Promise.resolve({ data: tradeAggregationResponse }));

        this.server.tradeAggregation(RoverSdk.Asset.native(), new RoverSdk.Asset('BTC', "GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH"), 1512689100000, 1512775500000, 300000)
          .call()
          .then(function (response) {
      ...
      it("requests the correct endpoint credit/native", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/trade_aggregations?base_asset_type=credit_alphanum4&base_asset_code=BTC&base_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH&counter_asset_type=native&start_time=1512689100000&end_time=1512775500000&resolution=300000'))
          .returns(Promise.resolve({ data: tradeAggregationResponse }));

        this.server.tradeAggregation(new RoverSdk.Asset('BTC', "GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH"), RoverSdk.Asset.native(), 1512689100000, 1512775500000, 300000)
          .call()
          .then(function (response) {
            expect(response.records).to.be.deep.equal(tradeAggregationResponse._embedded.records);
            expect(response.next).to.be.function;
    ...
    describe("AssetsCallBuilder", function() {
      it("requests the correct endpoint", function (done) {
        let assetsResponse ={
          "_links": {
            "self": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=1\u0026cursor="
            },
            "next": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=1\u0026cursor=9HORIZONS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12"
            },
            "prev": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=desc\u0026limit=1\u0026cursor=9HORIZONS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12"
            }
          },
          "_embedded": {
            "records": [
        ...
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/assets?limit=1'))
      ...
      it("requests the correct endpoint (asset_code)", function (done) {
        let assetsCodeResponse = {
          "_links": {
            "self": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=1\u0026cursor=\u0026asset_code=USD"
            },
            "next": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=1\u0026cursor=USD_GCYK67DDGBOANS6UODJ62QWGLEB2A7JQ3XUV25HCMLT7CI23PMMK3W6R_credit_alphanum4\u0026asset_code=USD"
            },
            "prev": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=desc\u0026limit=1\u0026cursor=USD_GCYK67DDGBOANS6UODJ62QWGLEB2A7JQ3XUV25HCMLT7CI23PMMK3W6R_credit_alphanum4\u0026asset_code=USD"
            }
          },
          "_embedded": {
            "records": [
        ...
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/assets?asset_code=USD&limit=1'))
      ...
      it("requests the correct endpoint (asset_issuer)", function (done) {
        let assetIssuerResponse = {
          "_links": {
            "self": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=10\u0026cursor=\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN"
            },
            "next": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=asc\u0026limit=10\u0026cursor=00acc1_GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN_credit_alphanum12\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN"
            },
            "prev": {
              "href": "http://orbit-testnet.rover.network:1337/assets?order=desc\u0026limit=10\u0026cursor=004d40_GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN_credit_alphanum12\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN"
            }
          },
          "_embedded": {
            "records": [
        ...
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/assets?asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN&limit=1'))
      ...
      let assetCodeIssuerResponse = {
        "_links": {
          "self": {
            "href": "http://orbit-testnet.rover.network/assets?order=asc\u0026limit=10\u0026cursor=\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR"
          },
          "next": {
            "href": "http://orbit-testnet.rover.network/assets?order=asc\u0026limit=10\u0026cursor=USD_GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR_credit_alphanum4\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR"
          },
          "prev": {
            "href": "http://orbit-testnet.rover.network/assets?order=desc\u0026limit=10\u0026cursor=USD_GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR_credit_alphanum4\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR"
          }
        },
        "_embedded": {
          "records": [
            {
              "_links": {
                "toml": {
                  "href": "https://bakalr/.well-known/rover.toml"
                }
              },
              "asset_type": "credit_alphanum4",
              "asset_code": "USD",
      ...
      it("requests the correct endpoint (asset_code then asset_issuer)", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/assets?asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR&asset_code=USD'))
      ...
      it("requests the correct endpoint (asset_issuer then asset_code)", function (done) {
        this.axiosMock.expects('get')
          .withArgs(sinon.match('http://orbit-testnet.rover.network:1337/assets?asset_code=USD&asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR'))
          .returns(Promise.resolve({data: assetCodeIssuerResponse}));
